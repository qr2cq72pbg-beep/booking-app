...
-- Membership create/claim helpers live in supabase-safe-customer-identity-linking.sql.
-- This file no longer CREATE OR REPLACEs:
--   _ensure_business_customer_membership
--   register_customer_business_membership
-- Re-running this file therefore cannot restore unsafe email-OR-phone claiming.
-- Run supabase-safe-customer-identity-linking.sql after this file.

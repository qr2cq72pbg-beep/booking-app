...
-- Patch create_booking: replace working-days check only (run full function from previous message
-- but swap the block below). This file updates _assert_booking_slot_available too.
